...
class Macro(Plugin):
    ...
    @command(
        "^emojify ([\u2600-\u26FF\u2700-\u27BF\U0001F1E6-\U0001F1FF\U0001F300-\U0001F5FF\U0001F600-\U0001F64F\U0001F680-\U0001F6FF]|(?:<:[A-Za-z0-9_]*:\d*>)) (.*)",
        access=-1,
        name='emojify',
    ...
    @command(
        "^waddle$", access=100, name='waddle',
        doc_brief=(u"`waddle`: Prints out the dankest of \U0001F427 Penguin "
                   u"\U0001F427 memes")
    )
    ...
    @command(
        "^plumber|cancer|<:mario:[0-9]*>$", access=100, name='plumber',
